!function (e) {
    ...
    e((function () {
        ...
        e(document).on("click", "[data-lightbox]", lity.options("template", '<div class="lity" role="dialog" aria-label="Dialog Window (Press escape to close)" tabindex="-1"><div class="lity-wrap" data-lity-close role="document"><div class="lity-loader" aria-hidden="true">Loading...</div><div class="lity-container"><div class="lity-content"></div><div class="lity-close" data-lity-close aria-label="Close (Press escape to close)"><span class="btn-line"></span></div></div></div></div>')), function (t) {
            ...
            matchMedia: "(min-width: 991.98px)",
            columns: 3
        }], "rc-mb-0"]]), window.addEventListener("resize", i), i(), e('.navbar .navbar-nav .nav-link[href^="#"]').each((function () {
        ...
        })), t("#about .skills-section", (function () {
            var t = function () {
                e("#about .skills-section .single-skill").each((function () {
                    var t = Math.min(100, Math.max(0, e(this).data("percentage"))),
                        i = e(this).find(".skill-progress").outerWidth(!0), a = i - i * (t / 100);
            ...
            e("#contact .contact-section .contact-form").on("submit", (function (t) {
                var i = e(this), a = i.find("#contact-submit"), n = a.text(), o = i.find(".contact-feedback");
